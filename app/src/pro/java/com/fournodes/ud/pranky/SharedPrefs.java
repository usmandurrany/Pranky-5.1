...
public class SharedPrefs {
    ...
    public void initAllPrefs() {
        ...
        stealthMode = prefs.getBoolean(SharedPrefs.STEALTH_MODE, false);
    ...
    public static void setStealthMode(boolean stealthMode) {
        prefs.edit().putBoolean(SharedPrefs.STEALTH_MODE, stealthMode).apply();
        SharedPrefs.stealthMode = stealthMode;
    }
}
